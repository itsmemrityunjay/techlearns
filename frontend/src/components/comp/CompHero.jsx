...
const Competitions = () => {
    ...
    return (
        <div className='container mx-auto py-8 ' >
            ...
            <div
  className="w-full mt-5 flex flex-col md:flex-row items-start justify-between max-w-8xl p-4 md:p-6 rounded-xl bg-cover bg-no-repeat bg-center"
  style={{
    backgroundImage: window.innerWidth >= 768 ? `url(${heroimg})` : "none",
    backgroundColor: window.innerWidth < 768 ? "#cf9dd1" : "transparent",
    height: "auto",
    minHeight: "450px",
  }}
>
  ...
  <div className="flex-1 mb-6 md:mb-0 mt-8 md:mt-14 px-4 md:ml-12 flex flex-col justify-center">
    ...
    <p className="text-gray-600 mb-6 text-sm sm:text-base md:text-lg leading-relaxed">
      Grow your data science skills by competing in our exciting <br className="hidden md:inline" /> competitions. Find help in the{' '}
      <a
    ...
    <div className="flex space-x-4">
      <button
        className="bg-[--secondary-color] hover:bg-[--primary-color] text-white font-semibold py-2 px-6 rounded-full transition duration-200 text-sm sm:text-base"
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 overflow-y-auto p-4">
    <div className="bg-white p-4 md:p-8 rounded-[20px] shadow-lg w-full max-w-6xl relative overflow-y-auto max-h-[90vh]">
      <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:ml-24 text-center md:text-left" style={{ fontFamily: "roboto" }}>
        Host a Competition
      </h2>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="mt-6 md:mt-0 w-full md:w-1/2 flex justify-center md:justify-end overflow-y-auto">
          <img className="w-11/12 rounded-lg object-contain" src={form1} alt="Competition Visual" />
        </div>
      </div>
    </div>
  </div>
