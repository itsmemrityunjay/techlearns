...
const TechSection = () => {
    ...
    return (
        <div className='container mx-auto'>
            <div className="relative flex flex-col md:flex-row justify-between items-center py-16 gap-12 rounded-none w-screen max-w-full mt-12 mb-12 overflow-hidden">
