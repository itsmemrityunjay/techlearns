              ...
              >
                ...
                >
                  ...
                  <div className={`absolute ${index % 2 === 0 ? '-left-16' : '-right-10'} top-1/2 transform -translate-y-1/2`}>
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center ${activeStep >= index ? 'bg-blue-500' : 'bg-gray-200'}`}>
                  ...
                  <div className={`p-8 rounded-lg shadow-md transition-all duration-300 ${activeStep >= index ? 'bg-white' : 'bg-gray-50'}`}>
                    <div className={`font-semibold mb-2 ${activeStep >= index ? 'text-blue-500' : 'text-gray-500'}`}>
                      0{index + 1}
                    </div>
